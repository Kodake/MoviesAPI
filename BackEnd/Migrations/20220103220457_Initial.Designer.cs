...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Entities.Cine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Entities.CineOferta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Entities.PeliculaActor", b =>
                {
            ...
            modelBuilder.Entity("BackEnd.Entities.SalaDeCine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Entities.CineOferta", b =>
                {
                    b.HasOne("BackEnd.Entities.Cine", null)
                        .WithOne("CineOferta")
                        .HasForeignKey("BackEnd.Entities.CineOferta", "CineId")
            ...
            modelBuilder.Entity("BackEnd.Entities.SalaDeCine", b =>
                {
                    b.HasOne("BackEnd.Entities.Cine", "Cine")
            ...
            modelBuilder.Entity("GeneroPelicula", b =>
                {
                    b.HasOne("BackEnd.Entities.Genero", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PeliculaSalaDeCine", b =>
                {
                    ...
                    b.HasOne("BackEnd.Entities.SalaDeCine", null)
                        .WithMany()
